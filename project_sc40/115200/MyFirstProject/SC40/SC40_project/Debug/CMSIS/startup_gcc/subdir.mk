...
CMSIS/startup_gcc/%.o: ../CMSIS/startup_gcc/%.c
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -O0 -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections  -g3 -I../drivers/mss_uart/ -I../drivers/mss_gpio/ -I../CMSIS/ -std=gnu11 --specs=cmsis.specs -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
