...
BUILDCMD = arm-none-eabi-gcc -mthumb -mcpu=cortex-m3 -specs=bare.specs -T ../CMSIS/startup_gcc/production-smartfusion2-execute-in-place.ld -Wl,-Map=$(EXECUTABLE).map 
SHELL := cmd.exe
